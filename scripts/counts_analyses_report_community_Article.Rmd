---
title: "Statistical analysis report for 'Multi-kingdom microbial community modulates its metabolism under contrasted cloud conditions'."
...
```{r intensity_metaB_WN_Figure3_panelA}
...
#   scale_y_continuous(labels = function(x) format(x * 100, scientific = FALSE, digits=3), 
#                      limits = c(0,NA), breaks = extended_breaks(n=5)) -> plot_wn
...
```{r intensity_metaB_SD_Figure3_panelB}
...
#   # facet_wrap(~name, scale="free", ncol=2) +
#   scale_y_continuous(labels = function(x) format(x * 100, scientific = FALSE, digits=3), 
#                      limits = c(0,NA), breaks = extended_breaks(n=5)) -> plot_sd
# 
# print(plot_sd)
# 
